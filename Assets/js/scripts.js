...
$(function () {
  ...
  // fucion pop-up tiendas
// Mostrar el popup cuando se hace clic en el botón
document.querySelector('.btn-popUp-tiendas').addEventListener('click', function () {
  document.querySelector('.popUptiendas').style.display = 'flex';
  setTimeout(function() {
      document.querySelector('.container-popUp').style.transform = 'scale(1.0)';
  }, 100); // Corregido el error de sintaxis
});

  // Cerrar el popup cuando se hace clic fuera del contenedor
  document.querySelector('.popUptiendas').addEventListener('click', function (event) {
      if (event.target === this) { // Solo cerrar si se hace clic fuera del popup
          this.style.display = 'none';
          setTimeout(function() {
            document.querySelector('.container-popUp').style.transform = 'scale(0)';
        }, 100);
      }
  });
