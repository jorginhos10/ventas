...
switch ($_GET["op"]) {
	...
	case 'permisos':
		...
		foreach ($rspta as $reg) {
			...
			echo '<li><label class="custom-switch mt-2"><input type="checkbox" ' . $sw . ' name="permiso[]" value="' . $reg['idpermiso'] . '" class="custom-switch-input"><span class="custom-switch-indicator"></span><span class="custom-switch-description">' . $reg['nombre'] . '</span></label></li>';
