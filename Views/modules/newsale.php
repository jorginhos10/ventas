                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-xs-6">
                                            ...
                                            <input class="form-control" type="text" name="num_comprobante"
                                                ...
                                                <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    ...
                                                    <select onchange="ShowTipopago()" name="tipo_pago" id="tipo_pago" class="form-control" required>
                                                ...
                                                <div class="form-group  col-lg-12 col-md-12 col-xs-12">
                                                    <div class="table-responsive">
                                                        <table id="detalles" class="table table-striped table-hover text-center table-sm">
                                                            <thead class="bg-aqua">
                                                                <th class="">Opción</th>
                                                ...
                                                <div class="form-group  col-lg-12 col-md-12 col-xs-12">
                                                    <div>
                                                        ...
                                                        <div style="height: 31px;">
                                                            <span> TOTAL</span> <span id="most_total" class="pull-right">0.00</span>
                                                        </div>
                                                        <div style="height: 31px;">
                                                            <input type="hidden" step="0.01" name="total_venta" id="total_venta">
                                                            <div class="pull-right form-inline">
                                                                <label for="tpagado"> Cant. pagado: </label>
                                                                <input class="form-control" oninput="modificarSubtotales()" style="width: 100px; height: 31px;" type="number" step="0.01" name="tpagado" id="tpagado">
                                                            </div>
                                                        ...
                                                        <div style="height: 31px;">
                                                            <div class="pull-right ">
                                                                <div class="d-flex bd-highlight">
                                                                    ...
                                                                    <span id="vuelto" class="p-2 flex-shrink-2 bd-highlight">0.00</span>
                                                                </div>
                                                ...
                                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <a href="listsales"><button class="btn btn-danger" type="button" id="btnCancelar"><i class="fa fa-arrow-circle-left"></i>
                                                            Cancelar</button></a>
                                                </div>
                                            </div>
                                        </form>
